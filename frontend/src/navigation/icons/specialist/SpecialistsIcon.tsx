...
function SpecialistsIcon({ hovered, isActive }: IconProps) {
    ...
    return (
    <svg className="feather feather-users" fill="none" height="24" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"
