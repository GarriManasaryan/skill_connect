        ...
        .then(()=>{
            profiles.forEach(async (profile) =>{
                if (profile.sellerPic != null){
                    let localProfilePicDict: profilePicDictType = {}
                    console.log(profilePicDict)
                    ...
                    localProfilePicDict[profile.id] = imageObjectURL
                    setProfilePicDict({...profilePicDict, ...localProfilePicDict})

                    console.log('AFTER SET PROFILE PIC')
                    console.log(profilePicDict)
